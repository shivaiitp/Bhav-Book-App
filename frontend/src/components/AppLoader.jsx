    ...
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center ${
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-20 left-20 w-32 h-32 ${
          darkMode ? 'bg-sky-500/10' : 'bg-sky-500/5'
        ...
        } rounded-full blur-xl animate-pulse`} style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative text-center">
        ...
        <div className="relative">
          <div className="w-12 h-12 border-4 border-sky-200 dark:border-sky-800 rounded-full animate-spin mx-auto">
            <div className="absolute top-0 left-0 w-12 h-12 border-4 border-transparent border-t-sky-600 rounded-full animate-spin"></div>
          </div>
        </div>
